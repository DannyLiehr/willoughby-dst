...
local function normal_postinit(inst)
	...
	inst:AddTag("thorny")
    inst.components.pickable:SetUp("raspberry", TUNING.BERRY_REGROW_TIME)
...
return createbush("raspberrybush", "raspberrybush", "raspberry", normal_postinit)
