return {
	ACTIONFAIL =
	{
		...
		SHAVE =
		{
			AWAKEBEEFALO = "I don't think he likes that.",
        ...
        GIVE =
        {
            ...
            BUSY = "Sorry. One more time?",
        },
        GIVETOPLAYER = 
        {
        	FULL = "I don't think they can hold all this!",
            DEAD = "Sorry. I'll wait, okay?",
            SLEEPING = "I'll wait until they're awake.",
            BUSY = "Sorry. One more time?",
    	},
    	GIVEALLTOPLAYER = 
	...
	ANNOUNCE_EATMEAT = "I hate it! No! No no no!",
	ANNOUNCE_EATRAWMEAT = "AAAAAAAAH!",
    ...
    --Modded Entities--
		DOC = 
		{
			GENERIC = "It's Mister %s from the missing posters! Hi!",
	...
	ELIXIR = "Gross, medicine!",
	GREEN_POTION = "Can I get something to drink after it?",
	YELLOW_POTION = "I can move even faster!",
	ORANGE_POTION = "Doctor Higgsbury said that rabbits don't drink this.",
	FIRE_POTION = "It's like vegetable soup in a bottle!",
	ICE_POTION = "Ooh, that's cold.",
	DREAM_CATCHER = "It's catching my nightmares, but all that has to go somewhere.",
	SAP = "It's not ready yet.",
	MAPLESYRUP = "This makes me homesick.",
	TRAPPER_HAT = "Now I won't freeze so easily!",
	MAPLEPOP = "Mrs. Feller down the street made these all the time!",
	POPSPEAR = "Now, this is playing with your food!",
	
	BBQ = {
		GENERIC = "It's a grill, eh.",
		ON = "I could roast carrots on it!",
		OFF = "I don't think it'll do much if it's off.",
		LOWFUEL = "Maybe I need to make it hotter?",
		BURNT = "Too hot.",
	},
